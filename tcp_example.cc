...
int main() {
  ...
  // Use TcpNewReno instead of UdpSocketFactory for TCP variant
  ns3::OnOffHelper onOffHelper("ns3::TcpSocketFactory", ns3::InetSocketAddress(interfaces.GetAddress(1), 9));
